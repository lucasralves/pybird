...
if __name__ == '__main__':
    ...
    ax.scatter(model.geo.body_params.p10e[0], model.geo.body_params.p10e[1], model.geo.body_params.p10e[2], color='red')
    ax.scatter(model.geo.body_params.p10d[0], model.geo.body_params.p10d[1], model.geo.body_params.p10d[2], color='red')
    ax.scatter(model.geo.tail_params.v5e[0], model.geo.tail_params.v5e[1], model.geo.tail_params.v5e[2], color='red')
    ax.scatter(model.geo.tail_params.v6e[0], model.geo.tail_params.v6e[1], model.geo.tail_params.v6e[2], color='red')
    ax.scatter(model.geo.tail_params.v7e[0], model.geo.tail_params.v7e[1], model.geo.tail_params.v7e[2], color='red')
    ax.scatter(model.geo.tail_params.v5d[0], model.geo.tail_params.v5d[1], model.geo.tail_params.v5d[2], color='red')
    ax.scatter(model.geo.tail_params.v6d[0], model.geo.tail_params.v6d[1], model.geo.tail_params.v6d[2], color='red')
    ax.scatter(model.geo.tail_params.v7d[0], model.geo.tail_params.v7d[1], model.geo.tail_params.v7d[2], color='red')
    ...
    ax.plot(model.geo.tail_params.curve39e[:, 0], model.geo.tail_params.curve39e[:, 1], model.geo.tail_params.curve39e[:, 2], color='orange')
    ax.plot(model.geo.tail_params.curve40e[:, 0], model.geo.tail_params.curve40e[:, 1], model.geo.tail_params.curve40e[:, 2], color='orange')
    ax.plot(model.geo.tail_params.curve41e[:, 0], model.geo.tail_params.curve41e[:, 1], model.geo.tail_params.curve41e[:, 2], color='orange')
    ax.plot(model.geo.tail_params.curve42e[:, 0], model.geo.tail_params.curve42e[:, 1], model.geo.tail_params.curve42e[:, 2], color='orange')
    
    ax.plot(model.geo.tail_params.curve39d[:, 0], model.geo.tail_params.curve39d[:, 1], model.geo.tail_params.curve39d[:, 2], color='orange')
    ax.plot(model.geo.tail_params.curve40d[:, 0], model.geo.tail_params.curve40d[:, 1], model.geo.tail_params.curve40d[:, 2], color='orange')
    ax.plot(model.geo.tail_params.curve41d[:, 0], model.geo.tail_params.curve41d[:, 1], model.geo.tail_params.curve41d[:, 2], color='orange')
    ax.plot(model.geo.tail_params.curve42d[:, 0], model.geo.tail_params.curve42d[:, 1], model.geo.tail_params.curve42d[:, 2], color='orange')
