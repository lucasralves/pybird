from numpy import asarray, gradient, linspace, zeros, ndarray
from scipy.interpolate import splprep, splev
from scipy.integrate import simpson

def interpolate_2D(points: ndarray, n: int) -> ndarray:
...
def interpolate_3D(points: ndarray, n: int) -> ndarray:
...
def lenght(points: ndarray) -> float:
...
def interpolate_fixed_ds(points: ndarray, dl: float, removeEdges: bool = False) -> ndarray:
